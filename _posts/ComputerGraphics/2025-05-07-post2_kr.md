...
- 이것이 복잡하고 사실적인 색상을 만드는 원리입니다.
    - **초기 상태**
        - 흰색 광선 (RGB = $[1, 1, 1]$).
    - **1차 반사 (Bounce 1)**
        - 붉은 빛이 도는 벽(확산 반사율 $[0.8, 0.2, 0.2]$)에 부딪힙니다.
        - 광선은 붉은 빛이 도는 빛이 됩니다.
    - **2차 반사 (Bounce 2)**
        - 푸른 빛이 도는 바닥(확산 반사율 $[0.3, 0.7, 0.3]$)에 부딪힙니다.
...
- 입사 단위 벡터 $a$, 단위 법선 벡터 $n$, 굴절 단위 벡터 $b$에 대해: <br><br>
   
    $$
...
- 그런 다음, 이 공식은 주어진 각도 $\theta$를 기반으로 반사율을 근사화하는 데 활용됩니다. <br><br>
     
    $$
