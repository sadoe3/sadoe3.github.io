...
- This relationship is described by **Lambert's Cosine Law**.
    ...
    <img src="/assets/images/raytracing/post2/lamberts_cosine_law.png" alt="lamberts_cosine_law" style="width: 70%; display: block; margin: 0 auto;">
...
- **Bounce 2**
    ...
    <img src="/assets/images/raytracing/post2/scenario_1.png" alt="scenario_1" style="width: 70%;height: 70%">
...
- The final pixel value is the cumulative result of all these color-filtering interactions, which is why a single ray's journey through a scene is what determines the final pixel's color.
    ...
    <img src="/assets/images/raytracing/post2/scenario_2.png" alt="scenario_2" style="width: 70%;height: 70%">
...
- This duality  is fundamental to accurate shading.
    ...
    <img src="/assets/images/raytracing/post2/macro_micro.png" alt="macro_micro" style="width: 70%;height: 70%">
