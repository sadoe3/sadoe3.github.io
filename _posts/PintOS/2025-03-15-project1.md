...
- **`timer.c`**
  ...
  - **`timer_interrupt()`**
    - Adds a call to `thread_wakeup()` with `timer_ticks()` value.
      <details markdown="1">
      <summary><b>Click</b> to see the refined code</summary>
...
- **`thread.h`**
  - **`struct thread`**
    - Adds `int64_t tick_wakeup` for wake-up time.
      <details markdown="1">
      <summary><b>Click</b> to see the refined code</summary>
...
- **`thread.h`**
  - **`struct thread`**
    - Adds `lock_to_wait`, `original_priority`, `donors`, `donelem`.
      <details markdown="1">
      <summary><b>Click</b> to see the refined code</summary>
