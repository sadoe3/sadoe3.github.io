...
- This increased bit depth is essential for High Dynamic Range (HDR) rendering, enabling the storage of light values greater than 1.0 and ensuring mathematically precise lighting calculations without data loss.
    ...
    <img src="/assets/images/raytracing/post1/color_channel.png" alt="color_channel" style="width: 70%; display: block; margin: 0 auto;">
...
- To summarize:
    ...
    <img src="/assets/images/raytracing/post1/linear_and_gamma.png" alt="linear_and_gamma" style="width: 70%; display: block; margin: 0 auto;">
...
- By allocating more bits to represent these darker shades,
    ...
    <img src="/assets/images/raytracing/post1/srgb.png" alt="srgb" style="width: 70%; display: block; margin: 0 auto;">
...
- The relationship between linear and gamma-corrected values is illustrated by the following graphical representation of the gamma encoding and decoding curves.
    ...
    <img src="/assets/images/raytracing/post1/graph_revised.png" alt="graph_revised" style="width: 70%; display: block; margin: 0 auto;">
...
- **Figure 1: The Perceptual Mid-Gray Mapping**.
    ...
    <img src="/assets/images/raytracing/post1/18_gray.png" alt="18_gray" style="width: 70%; display: block; margin: 0 auto;">
...
- Failure to properly manage this transfer function can lead to an image that is significantly darker or has an incorrect tonal balance.
    ...
    <img src="/assets/images/raytracing/post1/transfer.png" alt="transfer" style="width: 70%; display: block; margin: 0 auto;">
...
- A common simplification uses a gamma value of 2 to illustrate the conversion between linear and gamma spaces.
    ...
    * To convert a linear value $l$ back to a gamma-encoded value $g$:
    ...
    <img src="/assets/images/raytracing/post1/gamma_curve.png" alt="gamma_curve" style="width: 70%; display: block; margin: 0 auto;">
...
- These textures store data that represents physical properties of a surface (e.g., direction of a normal, surface roughness), not color.
    ...
    <img src="/assets/images/raytracing/post1/data_texture.png" alt="data_texture" style="width: 70%; display: block; margin: 0 auto;">
...
- The following stages outline this pipeline.
    ...
    <img src="/assets/images/raytracing/post1/process.png" alt="process" style="width: 70%; display: block; margin: 0 auto;">
...
- For example, a linear mid-gray of 0.5 will be treated by the display as a gamma value and will be displayed as $0.5^{2.2} \approx 0.22$, which is perceptually very dark.
    ...
    <img src="/assets/images/raytracing/post1/darker.png" alt="darker" style="width: 70%; display: block; margin: 0 auto;">
