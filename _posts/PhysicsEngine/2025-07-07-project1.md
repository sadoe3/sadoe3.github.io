...
<img src="/assets/images/physicsengine/overview/stress_test.gif" alt="Overview of the physics engine simulation running in DirectX 12" style="width: 50%;height: 50%">
<img src="/assets/images/physicsengine/overview/sandbox.gif" alt="Overview of the physics engine simulation running in DirectX 12" style="width: 50%;height: 50%">
...
- To prevent occlusion, selected objects and their collision pairs can be switched to wireframe mode.
- For convex shapes, the specific **triangle** involved in the collision is highlighted.

[add image/gif here]
*(Caption: Wireframe rendering highlighting the specific triangle involved in the collision)*

#### **Contact Data**
- Contact points are rendered as interactive red boxes, and collision normals are visualized as yellow arrows.
- This allows for visual verification of the mathematical collision resolution.

[add image/gif here]
*(Caption: Visualization of contact manifolds: Red boxes denote contact points, and yellow arrows indicate normal vectors)*
...
- To analyze transient bugs or high-speed events, a **Circular History Buffer** was implemented.
- **Functionality:** 
    - The engine records the full state (Transform, Velocity) of all rigid bodies for the last 120 frames.
- **Debugging:** 
    - A UI slider allows the user to scrub backward and forward through time, enabling frame-perfect analysis of collision initiation and response.
...
[add image/gif here]
(Caption: Stress test scene setup with configurable parameters)
...
[add image/gif here]
*(Caption: Overview of the sandbox environment featuring multiple physics test cases)*
